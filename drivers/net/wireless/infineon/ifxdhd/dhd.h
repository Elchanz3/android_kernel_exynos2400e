...
#ifndef CONFIG_IFXDHD_CLM_PATH
#ifdef OEM_ANDROID
#if defined(CUSTOMER_HW4) && defined(PLATFORM_SLP)
#define CONFIG_IFXDHD_CLM_PATH "/lib/firmware/bcmdhd_clm.blob"
#else
#define CONFIG_IFXDHD_CLM_PATH "/etc/wifi/bcmdhd_clm.blob"
#endif /* CUSTOMER_HW4 && PLATFORM_SLP */
#else
#define CONFIG_IFXDHD_CLM_PATH "/var/run/bcmdhd_clm.blob"
#endif /* OEM_ANDROID */
#endif /* CONFIG_IFXDHD_CLM_PATH */
...
extern int dhd_dev_start_mkeep_alive(dhd_pub_t *dhd_pub, uint8 mkeep_alive_id, uint8 *ip_pkt,
	uint16 ip_pkt_len, uint8* src_mac_addr, uint8* dst_mac_addr, uint32 period_msec, uint16 ether_type);
...
#if defined(DHD_SSW_SPECIFIC_REQ)
#define VENDOR_FIRMWARE_PATH "/vendor/firmware"
