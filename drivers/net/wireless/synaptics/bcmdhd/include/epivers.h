...
#define EPI_COMMIT_ID		"(153ef7b9)"

/* Driver Version String, ASCII, 32 chars max */
#if defined (WLTEST)
#define EPI_VERSION_STR		"101.10.361.12601.4 (WLTEST)"
#elif (defined (BCMDBG_ASSERT) && !defined (BCMDBG_ASSERT_DISABLED))
#define EPI_VERSION_STR		"101.10.361.12601.4 (ASSRT)"
#else
#define EPI_VERSION_STR		"101.10.361.12601.4"
#endif /* BCMINTERNAL */
